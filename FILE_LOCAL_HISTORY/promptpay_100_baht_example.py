...
def generate_promptpay_qr(phone, amount=None):
    ...
    crc = calculate_crc16(payload_for_crc)
    final_payload = payload + f"6304{crc}"
...
if __name__ == "__main__":
    ...
    try:
        ...
        # Save QR code image
        qr_img.save("promptpay_100_baht.png")
        print(f"\n✅ QR Code image saved as 'promptpay_100_baht.png'")
    ...
    print(f"\n{'='*60}")
    print("Summary:")
    print(f"✅ Generated valid PromptPay QR code for {amount} THB")
    print(f"✅ Phone number: {phone_number} (formatted as +66{phone_number[1:]})")
    print(f"✅ QR code can be scanned by any PromptPay app")
    print(f"✅ Payload follows EMV QR Code specification")
    print(f"{'='*60}")